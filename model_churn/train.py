...
mlflow.set_experiment(experiment_id=368232440139635018) 
...
with mlflow.start_run():
    #Criando autolog para mostrar detalhes da run
    ...
    #Logando dicionario de metricas para comparar execuçoes do modelo
